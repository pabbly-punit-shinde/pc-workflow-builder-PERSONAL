...
import { ChooseFilterAppDrawer } from '../choose-app-route-filter-condition-drawer/chooseapproutefilterconditiondrawer';


// ----------------------------------------------------------------------

export default function ChooseAppFilterNode(sx, ...other) {
  ...
  const appName = 'Filter (Pabbly)';
  const stepName = 'Filter: Only Continue If...';
  ...
  return (
    <Box sx={{ display: 'flex', alignItems: 'center', flexDirection: 'column' }}>
      ...
      >
        <Tooltip title={appName} arrow placement="top" disableInteractive>
          ...
          >
            <Avatar
              variant="rounded"
              src="https://s3.us-west-2.amazonaws.com/connect.pabbly/images/1717070968-Filter--Pabbly-.png"
              sx={{
                p: 1,
                width: 48,
                height: 48,
      ...
      <ChooseFilterAppDrawer open={openDrawer} onClose={handleCloseDrawer} />
    </Box>
  );
}
